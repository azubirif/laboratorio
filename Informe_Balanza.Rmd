...
abline(m)
```
Obteniendo una ordenada en el origen de $1.57431$, y una pendiente de $-0.297$, con un coeficiente de correlación $R^2 = 0.7213$, obteniendo un error porcentual $\varepsilon = (1-R^2)\cdot 100 =27.87\%$. En este caso, la ordenada en el origen representa el peso del objeto. Este peso, cuando se midió en el laboratorio con intensidad nula, resultó ser de $mg=1.6041~(N)$. Comparándolo con este resultado, tenemos el error porcentual:
$$
...
```
Antes de representar tenemos que el amperímetro tiene una precisión (APUNTE: el error de resolucion es de $10mA$)
